...
<div class="stations view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $station->has('modified_by') ? $this->Html->link($station->modified_by->id, ['controller' => 'Users', 'action' => 'view', $station->modified_by->id]) : '' ?></td>
        </tr>
        <tr>
            <th><?= __('Id') ?></th>
        ...
        <tr>
            <th><?= __('Is Active') ?></th>
            <td><?= $station->is_active ? __('Yes') : __('No'); ?></td>
         </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Employees') ?></h4>
        <?php if (!empty($station->employees)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($station->employees as $employees): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($station->employees_bkp)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th><?= __('Id') ?></th>
                <th><?= __('Employee No') ?></th>
            ...
            <?php foreach ($station->employees_bkp as $employeesBkp): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($station->salary_masters)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th><?= __('Id') ?></th>
            ...
            <?php foreach ($station->salary_masters as $salaryMasters): ?>
            <tr>
    ...
    <div class="related">
        ...
        <?php if (!empty($station->users_bkp)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th><?= __('Id') ?></th>
                <th><?= __('Username') ?></th>
            ...
            <?php foreach ($station->users_bkp as $usersBkp): ?>
            <tr>
                <td><?= h($usersBkp->id) ?></td>
