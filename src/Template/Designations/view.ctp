...
<div class="designations view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($designation->modified_by) ?></td>
        </tr>
        <tr>
            <th><?= __('Created') ?></th>
        ...
        <tr>
            <th><?= __('Is Active') ?></th>
            <td><?= $designation->is_active ? __('Yes') : __('No'); ?></td>
         </tr>
    </table>
    <div class="related">
    ...
    <div class="related">
        ...
        <?php if (!empty($designation->salary_masters)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th><?= __('Id') ?></th>
            ...
            <?php foreach ($designation->salary_masters as $salaryMasters): ?>
            <tr>
