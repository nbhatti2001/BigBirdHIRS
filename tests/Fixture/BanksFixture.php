...
class BanksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'bank_name' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'branch_name' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'company_id' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'company_id' => 1,
            'user_id' => 1,
            'created' => '2017-02-25 05:50:44',
            'modified' => '2017-02-25 05:50:44',
            'modified_by' => 1,
            'is_active' => 1
        ],
    ];
