...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'company_id' => 1,
            'user_id' => 1,
            'created' => '2017-02-23 10:23:07',
            'modified' => '2017-02-23 10:23:07',
            'modified_by' => 1,
            'is_active' => 1
        ],
    ];
