...
class StationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'manager_id' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'company_id' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'company_id' => 1,
            'user_id' => 1,
            'created' => '2017-02-24 06:20:33',
            'modified' => '2017-02-24 06:20:33',
            'modified_by' => 1,
            'is_active' => 1
        ],
    ];
