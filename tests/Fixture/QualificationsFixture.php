...
class QualificationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'duration' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'institute' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'gpa' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'gpa' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-01-10',
            'modified' => '2017-01-10',
            'is_active' => 1
        ],
