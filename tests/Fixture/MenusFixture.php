...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'srno' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-02-15 06:43:18',
            'modified' => '2017-02-15 06:43:18'
        ],
    ];
}
